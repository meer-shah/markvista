...
// const RiskprofileTemplate = ({ id, title, onDelete, isChecked, onToggle }) => {
...
const RiskprofileTemplate = ({ id, title, onDelete, isChecked, onToggle, defaultProfile }) => {
  ...
  const handleEdit = () => {
    if (isChecked) {
      alert('Active risk profiles cannot be edited.');
      return;
    }
    navigate(`/edit1/${id}`);
  };
  ...
  return (
    <div className='app_rp'>
      ...
      <div className='app_rp-inner'>
        <div className='inner-item' onClick={handleEdit}>
          <img src={edit} alt="Edit Icon" />
        </div>

        <div className='inner-item' onClick={navigateToDescription}>
          <img src={description} alt="Description Icon" />
        </div>

        <div className='inner-item' onClick={navigateToMain}>
