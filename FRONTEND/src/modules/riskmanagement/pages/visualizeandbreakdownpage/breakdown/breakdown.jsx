...
//             </div>
//             <input type="number" value={winRate} onChange={(e) => setWinRate(parseFloat(e.target.value))} />
//           </div>
//           <div className="breakdown__form-group">
//             <div className="breakdown__label-tooltip">
...
//             </div>
//             <input type="number" value={riskRewardRatio} onChange={(e) => setRiskRewardRatio(parseFloat(e.target.value))} />
//           </div>
//           <div className="breakdown__form-group">
//             <div className="breakdown__label-tooltip">
...
//             </div>
//             <input type="number" value={accountSize} onChange={(e) => setAccountSize(parseFloat(e.target.value))} />
//           </div>
//           <div className="breakdown__form-group">
//             <div className="breakdown__label-tooltip">
...
//             </div>
//             <input type="number" value={numTrades} onChange={(e) => setNumTrades(parseFloat(e.target.value))} />
//           </div>
...
const Breakdown = ({ id, setData }) => {
  ...
  const handleRunStrategy = () => {
    ...
    // Ensure the values are parsed as floats and provide defaults if empty
    ...
    const data = generateData(
      parsedNumTrades,
      parsedWinRate / 100, // Convert percentage to decimal
